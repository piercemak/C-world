  ...
  return (
    <div className='w-full h-dvh flex p-6 gap-4 justify-center items-center'>
      ...
      <div className="fixed w-full h-full">      
          ...
          <div ref={dropdownRef} className="absolute bottom-50 left-4 md:left-10 xl:left-64 w-fit flex flex-col mb-4 text-white z-[10]">
            <button 
            ...
            <AnimatePresence>
              {seasonDropdownOpen && (
                <motion.div
                  ...
                  className="absolute bottom-[-200px] text-nowrap left-full ml-4 mt-1 text-[#5c5c5c] bg-black/80 rounded-md shadow-md backdrop-blur px-4 py-2"
                >
