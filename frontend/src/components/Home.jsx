            ...
            >
              ...
              >
                ...
                > 
                  <motion.span variants={inputVariants} className=' flex justify-start h-60 w-1 ml-4 bg-[#add8e6]'/>
                  <div className="flex flex-col w-full text-left ml-4 text-[50px] ">
                    <motion.span variants={inputVariants} className='tracking-wider'> Head to </motion.span>
                    <motion.span variants={inputVariants} className='tracking-wider'> the CearaWorld media diary </motion.span>
                  </div>
