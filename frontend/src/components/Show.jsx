  ...
  const skipTimes = {
    ...
    "itsalwayssunny": {
      seasons: {
        ...
        7: {
          1: { intro: { start: 82.0, end: 112.0 }, outro: { start: 1284, skipTo: "next" } },
          2: { intro: { start: 97.0, end: 127.0 }, outro: { start: 1245, skipTo: "next" } },
          3: { intro: { start: 96.0, end: 126.0 }, outro: { start: 1260, skipTo: "next" } },
          4: { intro: { start: 93.0, end: 123.0 }, outro: { start: 1291, skipTo: "next" } },
          5: { intro: { start: 87.0, end: 117.0 }, outro: { start: 1247, skipTo: "next" } },
          6: { intro: { start: 107.0, end: 137.0 }, outro: { start: 1184, skipTo: "next" } },
          7: { intro: { start: 94.0, end: 124.0 }, outro: { start: 1167, skipTo: "next" } },
          8: { intro: { start: 123.0, end: 153.0 }, outro: { start: 1229, skipTo: "next" } },
          9: { intro: { start: 77.0, end: 107.0 }, outro: { start: 1161, skipTo: "next" } },
          10: { intro: { start: 18.0, end: 48.0 }, outro: { start: 1222, skipTo: "next" } },
          11: { intro: { start: 89.0, end: 119.0 }, outro: { start: 1165, skipTo: "next" } },
          12: { intro: { start: 77.0, end: 107.0 }, outro: { start: 1180, skipTo: "next" } },
          13: { intro: { start: 37.0, end: 67.0 }, outro: { start: 1268, skipTo: "next" } },
        },            
        8: {
          1: { intro: { start: 132.0, end: 162.0 }, outro: { start: 1242, skipTo: "next" } },
          2: { intro: { start: 96.0, end: 126.0 }, outro: { start: 1166, skipTo: "next" } },
          3: { intro: { start: 40.0, end: 70.0 }, outro: { start: 1337, skipTo: "next" } },
          4: { intro: { start: 149.0, end: 179.0 }, outro: { start: 1268, skipTo: "next" } },
          5: { intro: { start: 83.0, end: 113.0 }, outro: { start: 1285, skipTo: "next" } },
          6: { intro: { start: 55.0, end: 85.0 }, outro: { start: 1259, skipTo: "next" } },
          7: { intro: { start: 73.0, end: 103.0 }, outro: { start: 1267, skipTo: "next" } },
          8: { intro: { start: 120.0, end: 150.0 }, outro: { start: 1268, skipTo: "next" } },
          9: { intro: { start: 122.0, end: 152.0 }, outro: { start: 1126, skipTo: "next" } },
          10: { intro: { start: 180.0, end: 210.0 }, outro: { start: 1227, skipTo: "next" } },
        },
        9: {
          1: { intro: { start: 103.0, end: 133.0 }, outro: { start: 1245, skipTo: "next" } },
          2: { intro: { start: 130.0, end: 160.0 }, outro: { start: 1259, skipTo: "next" } },
          3: { intro: { start: 108.0, end: 138.0 }, outro: { start: 1266, skipTo: "next" } },
          4: { intro: { start: 128.0, end: 158.0 }, outro: { start: 1268, skipTo: "next" } },
          5: { intro: { start: 86.0, end: 116.0 }, outro: { start: 1247, skipTo: "next" } },
          6: { intro: { start: 42.0, end: 72.0 }, outro: { start: 1283, skipTo: "next" } },
          7: { intro: { start: 103.0, end: 133.0 }, outro: { start: 1242, skipTo: "next" } },
          8: { intro: { start: 150.0, end: 180.0 }, outro: { start: 1177, skipTo: "next" } },
          9: { intro: { start: 62.0, end: 92.0 }, outro: { start: 1126, skipTo: "next" } },
          10: { intro: { start: 174.0, end: 204.0 }, outro: { start: 1136, skipTo: "next" } },
        },  
        10: {
          1: { intro: { start: 67.0, end: 97.0 }, outro: { start: 1180, skipTo: "next" } },
          2: { intro: { start: 72.0, end: 102.0 }, outro: { start: 1375, skipTo: "next" } },
          3: { intro: { start: 61.0, end: 91.0 }, outro: { start: 1261, skipTo: "next" } },
          4: { intro: { start: 30.0, end: 60.0 }, outro: { start: 1205, skipTo: "next" } },
          5: { intro: { start: 157.0, end: 187.0 }, outro: { start: 1221, skipTo: "next" } },
          6: { intro: { start: 62.0, end: 92.0 }, outro: { start: 1243, skipTo: "next" } },
          7: { intro: { start: 80.0, end: 110.0 }, outro: { start: 1168, skipTo: "next" } },
          8: { intro: { start: 115.0, end: 145.0 }, outro: { start: 1168, skipTo: "next" } },
          9: { intro: { start: 87.0, end: 117.0 }, outro: { start: 1182, skipTo: "next" } },
          10: { intro: { start: 65.0, end: 95.0 }, outro: { start: 1224, skipTo: "next" } },
        },   
        11: {
          1: { intro: { start: 105.0, end: 135.0 }, outro: { start: 1194, skipTo: "next" } },
          2: { intro: { start: 49.0, end: 79.0 }, outro: { start: 1273, skipTo: "next" } },
          3: { intro: { start: 115.0, end: 145.0 }, outro: { start: 1299, skipTo: "next" } },
          4: { intro: { start: 135.0, end: 165.0 }, outro: { start: 1235, skipTo: "next" } },
          5: { intro: { start: 60.0, end: 90.0 }, outro: { start: 1271, skipTo: "next" } },
          6: { outro: { start: 1024, skipTo: "next" } },
          7: { intro: { start: 107.0, end: 137.0 }, outro: { start: 1267, skipTo: "next" } },
          8: { intro: { start: 175.0, end: 205.0 }, outro: { start: 1291, skipTo: "next" } },
          9: { intro: { start: 60.0, end: 90.0 }, outro: { start: 1272, skipTo: "next" } },
          10: { intro: { start: 65.0, end: 95.0 }, outro: { start: 1350, skipTo: "next" } },
        },
        12: {
          1: { intro: { start: 147.0, end: 177.0 }, outro: { start: 1301, skipTo: "next" } },
          2: { intro: { start: 106.0, end: 136.0 }, outro: { start: 1078, skipTo: "next" } },
          3: { intro: { start: 98.0, end: 128.0 }, outro: { start: 1221, skipTo: "next" } },
          4: { intro: { start: 117.0, end: 147.0 }, outro: { start: 1140, skipTo: "next" } },
          5: { intro: { start: 62.0, end: 92.0 }, outro: { start: 1286, skipTo: "next" } },
          6: { intro: { start: 120.0, end: 150.0 }, outro: { start: 1265, skipTo: "next" } },
          7: { intro: { start: 215.0, end: 245.0 }, outro: { start: 1290, skipTo: "next" } },
          8: { intro: { start: 209.0, end: 239.0 }, outro: { start: 1280, skipTo: "next" } },
          9: { intro: { start: 108.0, end: 138.0 }, outro: { start: 1051, skipTo: "next" } },
          10: { intro: { start: 115.0, end: 145.0 }, outro: { start: 1281, skipTo: "next" } },
        },         
        13: {
          1: { intro: { start: 98.0, end: 128.0 }, outro: { start: 1258, skipTo: "next" } },
          2: { intro: { start: 105.0, end: 135.0 }, outro: { start: 1271, skipTo: "next" } },
          3: { intro: { start: 76.0, end: 106.0 }, outro: { start: 1150, skipTo: "next" } },
          4: { intro: { start: 78.0, end: 108.0 }, outro: { start: 1208, skipTo: "next" } },
          5: { intro: { start: 109.0, end: 139.0 }, outro: { start: 1369, skipTo: "next" } },
          6: { intro: { start: 112.0, end: 142.0 }, outro: { start: 1266, skipTo: "next" } },
          7: { intro: { start: 74.0, end: 104.0 }, outro: { start: 1183, skipTo: "next" } },
          8: { intro: { start: 176.0, end: 206.0 }, outro: { start: 1066, skipTo: "next" } },
          9: { intro: { start: 158.0, end: 188.0 }, outro: { start: 1112, skipTo: "next" } },
          10: { intro: { start: 86.0, end: 116.0 }, outro: { start: 1220, skipTo: "next" } },
        },     
        14: {
          1: { intro: { start: 96.0, end: 126.0 }, outro: { start: 1380, skipTo: "next" } },
          2: { intro: { start: 118.0, end: 148.0 }, outro: { start: 1292, skipTo: "next" } },
          3: { intro: { start: 177.0, end: 207.0 }, outro: { start: 1380, skipTo: "next" } },
          4: { intro: { start: 137.0, end: 167.0 }, outro: { start: 1344, skipTo: "next" } },
          5: { intro: { start: 133.0, end: 163.0 }, outro: { start: 1302, skipTo: "next" } },
          6: { outro: { start: 1288, skipTo: "next" } },
          7: { intro: { start: 99.0, end: 129.0 }, outro: { start: 1080, skipTo: "next" } },
          8: { intro: { start: 116.0, end: 146.0 }, outro: { start: 1195, skipTo: "next" } },
          9: { intro: { start: 129.0, end: 159.0 }, outro: { start: 1192, skipTo: "next" } },
          10: { intro: { start: 110.0, end: 140.0 }, outro: { start: 1219, skipTo: "next" } },
        },   
        15: {
          1: { intro: { start: 137.0, end: 167.0 }, outro: { start: 1303, skipTo: "next" } },
          2: { intro: { start: 116.0, end: 146.0 }, outro: { start: 1276, skipTo: "next" } },
          3: { intro: { start: 60.0, end: 90.0 }, outro: { start: 1270, skipTo: "next" } },
          4: { intro: { start: 118.0, end: 148.0 }, outro: { start: 1239, skipTo: "next" } },
          5: { intro: { start: 100.0, end: 130.0 }, outro: { start: 1238, skipTo: "next" } },
          6: { intro: { start: 67.0, end: 97.0 }, outro: { start: 1274, skipTo: "next" } },
          7: { intro: { start: 108.0, end: 138.0 }, outro: { start: 1319, skipTo: "next" } },
          8: { intro: { start: 104.0, end: 134.0 }, outro: { start: 1270, skipTo: "next" } },
        }, 
        16: {
          1: { intro: { start: 194.0, end: 224.0 }, outro: { start: 1318, skipTo: "next" } },
          2: { intro: { start: 119.0, end: 149.0 }, outro: { start: 1282, skipTo: "next" } },
          3: { intro: { start: 75.0, end: 105.0 }, outro: { start: 1258, skipTo: "next" } },
          4: { intro: { start: 52.0, end: 82.0 }, outro: { start: 1185, skipTo: "next" } },
          5: { intro: { start: 69.0, end: 99.0 }, outro: { start: 1232, skipTo: "next" } },
          6: { intro: { start: 99.0, end: 129.0 }, outro: { start: 1226, skipTo: "next" } },
          7: { intro: { start: 139.0, end: 169.0 }, outro: { start: 1316, skipTo: "next" } },
          8: { intro: { start: 63.0, end: 93.0 }, outro: { start: 1341, skipTo: "next" } },
        }, 
      }
  },  
