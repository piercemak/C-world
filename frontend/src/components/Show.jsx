  ...
  const skipTimes = {
    ...
    "itsalwayssunny": {
      seasons: {
        ...
        7: {
          1: { intro: { start: 82.0, end: 110.0 }, outro: { start: 1284, skipTo: "next" } },
          2: { intro: { start: 97.0, end: 125.0 }, outro: { start: 1245, skipTo: "next" } },
          3: { intro: { start: 96.0, end: 124.0 }, outro: { start: 1260, skipTo: "next" } },
          4: { intro: { start: 93.0, end: 121.0 }, outro: { start: 1291, skipTo: "next" } },
          5: { intro: { start: 87.0, end: 115.0 }, outro: { start: 1247, skipTo: "next" } },
          6: { intro: { start: 107.0, end: 135.0 }, outro: { start: 1184, skipTo: "next" } },
          7: { intro: { start: 94.0, end: 122.0 }, outro: { start: 1167, skipTo: "next" } },
          8: { intro: { start: 123.0, end: 151.0 }, outro: { start: 1229, skipTo: "next" } },
          9: { intro: { start: 77.0, end: 105.0 }, outro: { start: 1161, skipTo: "next" } },
          10: { intro: { start: 18.0, end: 46.0 }, outro: { start: 1222, skipTo: "next" } },
          11: { intro: { start: 89.0, end: 117.0 }, outro: { start: 1165, skipTo: "next" } },
          12: { intro: { start: 77.0, end: 105.0 }, outro: { start: 1180, skipTo: "next" } },
          13: { intro: { start: 37.0, end: 65.0 }, outro: { start: 1268, skipTo: "next" } },
        },            
        8: {
