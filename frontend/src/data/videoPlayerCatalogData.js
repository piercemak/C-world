export const VIDEO_PLAYER_SIDEBAR_ITEMS = [
  ...
  { title: "Beck: Mongolian Chop Squad", cardId: "card-49" },  { title: "Widow's Bay", cardId: "card-50" },  { title: "Backrooms", cardId: "card-51" },  { title: "Pokémon: Destiny Deoxys", cardId: "card-52" },  { title: "Atlanta", cardId: "card-53" },  { title: "Chronicle", cardId: "card-54" },  { title: "JoJo's Bizarre Adventure", cardId: "card-55" },  { title: "Chernobyl", cardId: "card-56" },  { title: "Being John Malkovich", cardId: "card-57" },  { title: "Attack on Titan", cardId: "card-58" },  { title: "The Drama", cardId: "card-59" },
